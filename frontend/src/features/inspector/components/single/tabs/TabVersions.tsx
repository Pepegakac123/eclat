...
export const TabVersions = ({ asset }: TabVersionsProps) => {
  ...
  const [selectedDup, setSelectedDup] = useState<{id: number, name: string} | null>(null);
                      ...
                      endContent={
                        <Tooltip content="Delete Duplicate" color="danger">
                          <Button
                            ...
                            onClick={() => handleDeleteClick(dup.id, dup.fileName)}
                          >
                            <Trash2 size={14} />
                          </Button>
                        </Tooltip>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative ml-3.5 pl-6 border-l-2 border-default-100 flex flex-col gap-4">
              ...
              {timeline.map((version: app.AssetDetails) => (
                <div key={version.id} className="relative group animate-appearance-in">
